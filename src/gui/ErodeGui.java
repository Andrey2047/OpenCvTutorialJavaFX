...
import algorithm.ErodeDilationFunction;
...
import static algorithm.ErodeDilationFunction.dialate;
import static algorithm.ErodeDilationFunction.erode;
...
public class ErodeGui extends AbstractGUI {
    ...
    public void start(Stage stage) throws Exception {
        ...
        iterationNumberField = createSlider(0,20);
    ...
    private void refreshErodeImage(){
        ...
        Mat dialateImage = dialate(getImageArray(CURRENT_IMAGE), shape, kSize, iterationNumber);
        Mat baseImage = erode(dialateImage, shape, kSize, iterationNumber);
        erodedImageView.setImage(createImage(baseImage));
    }
